...
buttons: [
                { extend: 'excel', filename: 'LAgenda du Quebec - Liste des menulinks_'+ today},
                { extend: 'pdf', filename: 'LAgenda du Quebec - Liste des menulinks_'+ today }
        ],
                order: [[ 0, 'asc' ]],
                pageLength: 25,
                responsive: true,
                "oLanguage":{
                      ...
                      "sSearch":         "Rechercher&nbsp;:",
                      "sLengthMenu":     "Afficher   <select name=\"event-users-table_length\" aria-controls=\"event-users-table\" class=\"\"><option selected value=\"10\">10</option><option value=\"25\">25</option><option value=\"50\">50</option><option id='limit' value=\"100\">All</option></select> &eacute;l&eacute;ments",
