        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{route('admin.listevents')}}" class="btn btn-primary btn-sm"> <i
                            class="mr-2 fa fa-angle-double-left"></i> Retour vers la liste </a>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-md-3 announcement-side-bar">
                    <div class="announcement-meta-wrapper">
                        ...
                        <div class="row justify-content-between announcement-metas">
                            ...
                            <div class="col-6 meta-value"><span>{{@$event->category->name}}</span></div>
                            <div class="col-6">
                                @if(intval($event->publication_status) === 1)
                                <strong>Posté le :</strong></div>
                            <div class="col-6 meta-value"><span> {{date('Y/m/d', strtotime($event->published_at))}}
                                </span>
                                @else
                            ...
                            <div class="col-6"><strong>N° de l'événement :</strong></div>
                            <div class="col-6 meta-value px-4"><span>{{sprintf("%05d",@$event->id)}}</span></div>
                            ...
                            <ul class="row flex-column p-0 mx-1 publication-meta w-100">
                                ...
                                <li class="list-group-item"><i class="fa fa-map-marked-alt"></i> {{@$event->city->name}}
                                    <br> {{@$event->region->name}}</li>
                                @if(trim(@$event->website) !== "")<li class="list-group-item"><i
                                        class="fa fa-laptop-house"></i> {{@$event->website}}</li>@endif
                            </ul>
                            <div class="col-12 text-center">
                                <hr>
                            </div>
                        ...
                        <div class="bg-light p-2 mt-5">
                            ...
                            <h5><a class="btn-link"
                                    href="{{route('admin.show_announcement',@$event->announcement)}}">{{ucfirst($event->announcement->title)}}</a>
                            </h5>
                            <div>
                ...
                <div class="col-sm-12 col-md-9 announcement-container">
                    ...
                    <div class="announcement-dates mt-3 bg-gray-light px-3 py-3">
                        ...
                        <div class="col-sm-12 col-md-9">
                            ...
                            <span class="badge badge-primary list-event-dates"><i class="fa fa-calendar"></i>
                                {{ date( "Y/m/d",strtotime($date->event_date) )}} </span>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="d-flex  announcement-footer">
                        ...
                        intval(@$event->posted_by))
                        <div class="mx-2">
                            <a href="{{route('admin.edit_event',@$event)}}" class="btn btn-sm btn-primary"><i
                                    class="fa fa-edit"></i> Modifier </a>
                        </div>
                        <div class="mx-2">
                            <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-delete"
                                data-whatever="{{route('admin.delete_event',@$event)}}"><i class="fa fa-user-times"></i>
                                Supprimer</a>
                        </div>
                        @endif
                    </div>
