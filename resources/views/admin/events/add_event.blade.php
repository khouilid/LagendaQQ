...
<div class="row">
    ...
    <div class="badge text-danger badge-light mb-4 py-2" style="line-height: 2.4;">
        ...
        publier votre évènement.<br>Vous pouvez tout de même l'enregistrer en brouillon. Vous pouvez aussi
    </div>
    @endif
                ...
                <form action="{{route('admin.store_event')}}" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group row mt-5">
                            <a href="{{route('admin.edit_announcement',$announcement)}}" class="btn btn-success"><i
