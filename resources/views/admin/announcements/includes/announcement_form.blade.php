...
<div class="offset-sm-0 col-12 form-group row">
    ...
    <div class="col-sm-12 col-md-12"><textarea col="20" name="description" id="description"
...
<div id="price_field_wrapper" class="offset-sm-0 col-sm-12 col-md-6 form-group row"
    ...
    <input type="number" name="price" id="price" min="0.00" step="0.01" value="{{old('price',@$announcement->price)}}"
...
<div class="offset-sm-0 col-sm-12 col-md-6 form-group row">
    ...
    <select name="category_id" id="category_id" class="form-control">
        ...
        <option value="{{$category->id}}"
            {{intval(old('category_id',@$announcement->category_id)) === $category->id?'selected':''}}>
...
<div class="offset-sm-0 col-sm-12 col-md-6 form-group row">
    ...
    <select name="region_id" id="region_id" class="form-control">
        ...
        <option value="{{$key}}" {{ old('region_id',@$announcement->region_id) == $key ? "selected":"" }}>{{$region}}
        </option>
        @empty
        @endforelse
    </select>
...
<div class="offset-sm-0 col-sm-12 col-md-6 form-group row">
    ...
    <select name="city_id" id="city_id" class="form-control">
        ...
        <option value="{{$key}}" {{  old('city_id',@$announcement->city_id) == $key ? "selected":"" }}>{{$city}}
        </option>
        @empty
        @endforelse
    </select>
...
<div class="offset-sm-8 col-sm-12 col-md-4 form-group row">
    ...
    <select name="publication_status" id="publication_status" class="form-control">
        ...
        <option value="{{$key}}"
            {{ intval(old('publication_status',@$announcement->publication_status)) == $key ? "selected":"" }}>
            {{$statu}}</option>
        @empty
        @endforelse
    </select>
