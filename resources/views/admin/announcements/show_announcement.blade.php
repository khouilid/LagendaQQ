...
@section('content')
<div class="row">
    <a class="btn btn-primary mb-3" href="{{route('admin.announcements')}}"><i class="fa fa-angle-double-left"></i>
            ...
            <div class="card-body row overflow-hidden">
                <div class="col-sm-12 col-md-3 announcement-side-bar">
                    <div class="announcement-meta-wrapper">
                        ...
                        <div class="row justify-content-between announcement-metas">
                            ...
                            <div class="col-6"><strong>N° de l'annonce :</strong></div>
                            <div class="col-6 meta-value px-4"><span>{{sprintf("%05d",@$announcement->id)}}</span></div>
                ...
                <div class="col-sm-12 col-md-9 announcement-container">
                    ...
                    <div class="announcement-dates mt-3 bg-gray-light px-3 py-3">
                        ...
                        <h3 class="badge badge-primary list-event-dates"><i class="fa fa-calendar"></i>
                            {{$announcement->getPrice()}} </h3>
                    </div>
                    ...
                    <div class="d-flex  announcement-footer my-2">
                        <div class="mx-2"><a href="{{route('admin.edit_announcement',@$announcement)}}"
                        ...
                        <div class="mx-2">
                            <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-delete"
                                data-whatever="{{route('admin.delete_announcement',@$announcement)}}"><i
