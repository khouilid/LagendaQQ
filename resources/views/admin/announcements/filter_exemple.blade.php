            ...
            <div class="card-body">
                ...
                <table class="table table-success table-striped table-borderless" id="announcements-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="{{url("/admin/announcement/$annc->id")}}"><img
                                        src="{{url("/voir/images/$annc->images")}}" alt="{{@$annc->title}}"
                                        style="width:50px; height: auto"></a></td>
                            <td><strong>Region : </strong>{{@$annc->region->name}}<br><strong>Ville :
                                </strong>{{@$annc->city->name}}</td>
                            <td>{{$annc->postal_code}}</td>
                            <td>{{@$annc->category->name}}</td>
                            <td><a href="{{url("/admin/announcement/$annc->id")}}"><small>{{$annc->title}}</small></a>
                            </td>
                            <td>{{$annc->id}}</td>
