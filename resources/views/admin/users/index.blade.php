...
@section('page_title','Liste des utilisateurs (Super admin) ')
    ...
    <script>
        ...
        $(function() {
            let table = $('#event-users-table').DataTable({
                ...
                dom: 'Brliptip',
                  buttons: [
                    { extend: 'excel', filename: 'L\'Agenda du Quebec - Liste des utilisateurs _'+ today},
                    { extend: 'pdf', filename: 'L\'Agenda du Quebec - Liste des utilisateurs _'+ today }
