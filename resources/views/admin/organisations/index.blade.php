...
@section('page_title','Liste des organisation (suadm)')
    ...
    <script>
        ...
        $(function() {
            $('#event-organisations-table').DataTable({
                ...
                dom: 'Bfrliptip',
                buttons: [
                        { extend: 'excel', filename: 'LAgenda du Quebec - Les organisations_'+ today},
                        { extend: 'pdf', filename: 'LAgenda du Quebec - Les organisations_'+ today }
                ],
