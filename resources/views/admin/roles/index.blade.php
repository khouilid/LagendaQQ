        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title font-weight-bold">Liste des fonction (suadm)</h2>
                </div>
                <div class="card-body">
    ...
    var today = new Date();
        ...
        $(function() {
            ...
            $('#roles-table').DataTable({
                ...
                dom: 'Bfrliptip',
buttons: [
                { extend: 'excel', filename: 'LAgenda du Quebec - Liste les roles_'+ today},
                { extend: 'pdf', filename: 'LAgenda du Quebec - Liste les roles_'+ today }
        ],
