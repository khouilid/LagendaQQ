                    ...
                    <div class="announcement-meta-wrapper py-3">
                        ...
                        <div class="row justify-content-between announcement-metas">
                            ...
                            <div class="col-12 row">
                                ...
                                <div class="mt-2 alert alert-warning text-md">
                                    <p>La publication de cette annonce est bloquée.</p>
                                    <p>Elle doit étre liée à un événement pour être publiée.</p>
                                </div>
                                @else
                                @if(intval($announcement->publication_status) === 1 )
                                <div class="col-6"><strong>Posté le :</strong></div>
                                <div class="col-6 meta-value">
                                    <span>{{date('d/m/Y', strtotime($announcement->published_at))}}</span> </div>
                        ...
                        <div class="bg-light p-2 mt-5">
                            <strong><i class="fa fa-bullhorm mr-2"></i> Vers l'activité de l'annonce :</strong>
                            <div>
