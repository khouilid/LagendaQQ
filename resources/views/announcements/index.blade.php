        ...
        <div class="col-12 tab-content" id="nav-tabContent">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title font-weight-bold">Mes annonces  (Vacl) </h2>
    ...
    <script defer>
        ...
        $(function() {
            ...
            let table = $('#announcements-table').DataTable({
                            ...
                            dom: 'Brliptip',
                           buttons: [
                                    { extend: 'excel', filename: 'LAgenda du Quebec - Liste mes annonces_'+ today},
                                    { extend: 'pdf', filename: 'LAgenda du Quebec - Liste mes annonces_'+ today }
                            ],
                            ajax: {
