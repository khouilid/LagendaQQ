...
{{-- <div class="">
                ...
                @php 
                    ...
                    foreach($menus as $menu){
                        echo '<li class="nav-item ml-2 dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"> '.$menu->name.' </a>
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">';
                        if($menu->hasLinks()){
    ...
    as $category)
                                    <li><a  class="dropdown-item" href="{{route('announcement_page',$category)}}">{{ $category->name }}</a>
</li>
@endforeach
...
<a href="#" class="dropdown-item " data-role_id="{{$role->id}}" data-role_description="{!! $role->description !!}"
    data-role_name="{{$role->name}}">{{$role->name}}</a>
</div>
</li>
</ul>
@endforeach
...
{{-- <div class="ml-1">
            ...
            @auth
                <li class="nav-item dropdown"">
                    <a class="bg-primary" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-user-shield"></i>Profil</a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        @hasanyrole('super-admin')
                            @include('layouts.front.partials.su-admin')
                            @endrole
                        <a class="dropdown-item text-decoration-none" href="{{route('user.infosperso')}}/infos-perso"><i
    class="fa fa-user mr-1"></i>Mon compte</a>
@hasanyrole('banquier')
@include('layouts.front.partials.banker')
@endrole
@hasanyrole('chef-vendeur')
...
<hr> --}}
{{-- @hasanyrole('vendeur|super-admin|annonceur|admin')
                            <a class="dropdown-item" href="{{route('user.my_events')}}"><i
    class="fas fa-calendar-check"></i> Mes événements</a>
<a class="dropdown-item" href="{{route('user.my_announcements')}}"><i class="fa fa-bullhorn"></i> Mes Annonces</a>
@endrole --}}
{{-- <hr> --}}
{{-- <a class="dropdown-item link-success" href="{{route('user.infosperso')}}/transactions" title="Lsite de mes
transactions"><i class="fas fa-exchange-alt" aria-hidden="true"></i> Mes Transactions</a> --}}
{{-- <a class="dropdown-item link-primary" href="{{route('user.infosperso')}}/wallet" title="Mon Portefeuille"><i
    class="fa fa-wallet" aria-hidden="true"></i> Mon Portefeuille </a> --}}
{{-- <a class="dropdown-item link-primary" href="{{ route('logout') }}"
onclick="event.preventDefault();document.getElementById('logout-form').submit();">
<i class="fas fa-power-off mr-2"></i> Se déconnecter
</a>
