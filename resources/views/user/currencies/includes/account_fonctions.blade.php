                ...
                <div id="flush-collapse{{$fonction->id}}" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body ">
                        ...
                        <div class="col-12 row aq-card-action">
                            <a href="#" class="btn btn-success btn-sm">Vouse êtes déjà
                                {{strtolower($fonction->name)}}</a>
                        </div>
                        @else
                        <hr size="60%" class="mx-auto">
                        <div class="col-12 row aq-card-action" id="{{$fonction->id}}">
                            <a href="#" class="btn btn-primary btn-sm subscribe_role" data-role_id="{{$fonction->id}}"
                                data-role_description="{{$fonction->description}}"
        ...
        <div class="card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    ...
                    <h4 class='badge badge-warning mx-auto'><i class='fa fa-coins'></i> Monnaie utilisée :
                        {{$role->currency->name}}</h4>
