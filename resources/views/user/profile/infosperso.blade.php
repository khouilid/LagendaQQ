    ...
    <div class="row">
        ...
        <nav class="col-12">
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                {{-- <a class="nav-link {{@$default_tab=='functions'?'active':''}}" id="nav-security-tab" data-bs-toggle="tab" href="#nav-security" role="tab" aria-controls="nav-security" aria-selected="false"><i class="fa fa-cogs"></i>  </a> --}}
                <a class="nav-link {{@$default_tab=='events'?'active':''}}" id="nav-events-tab" data-bs-toggle="tab" href="#nav-events" role="tab" aria-controls="nav-events" aria-selected="false"><i class="fa fa-list"></i> Mes possibles</a>
            </div>
        </nav>
