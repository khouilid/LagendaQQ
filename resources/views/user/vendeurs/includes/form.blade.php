<div class="row responsive-annonceur">
    ...
    <div class="offset-sm-1 col-5 form-group row">
        <label for="email" class="col-sm-12 col-md-12">Adresse e-mail :* <small>L'utilisateur recevra un message à cette
                adresse avec tous les détails d'authentification</small></label>
