<div class="offset-sm-0 col-12 form-group row">
    ...
    <input type="text" maxlength="35" name="title" id="title" value="{{old('title',@$event->title)}}"
        class="form-control">
...
<div class="offset-sm-0 col-sm-12 col-md-6 form-group row">
    <img id="preview" src="{{ route('show_image',@$event->images) }}" alt="{{@$event->title}}"
...
<div class="offset-sm-0 col-sm-12 col-md-6 form-group row">
    <label for="datePick" class="col-sm-12 col-md-12">Dates de l'événement : * <br><small>Vous pouvez sélectionner
...
<div class="offset-sm-0 col-sm-12 col-md-6 form-group row">
    ...
    <select name="reservation" id="reservation_id" class="form-control">
        <option value=""> --- </option>
