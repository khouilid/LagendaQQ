        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{route('user.my_events')}}" class="btn btn-primary btn-sm"> <i
                            class="mr-2 fa fa-double-arrow-left"></i> Retour vers la liste </a>
                </div>
            </div>
            <div class="card-body row overflow-hidden">
                ...
                <div class="col-sm-12 col-md-9 announcement-container">
                    ...
                    <div class="row announcement-dates mt-3 bg-gray-light px-3 py-3">
                        <div class="col-sm-12 col-md-3"><span class="small font-bold">Date(s) de l'événement : </span>
                        </div>
...
<div class="col-sm-12 col-md-3"><span class="small font-bold">Vide :</span></div>
                    ...
                    <div class="d-flex  announcement-footer">
                        ...
                        <div class="mx-2">
                            <a href="{{route('user.edit_event',@$event->slug)}}" class="btn btn-sm btn-primary py-2"><i
                                    class="fa fa-edit"></i> Modifier </a>
                        </div>
                        <div class="mx-2">
                            <a href="#" class="btn btn-sm btn-danger py-2" data-toggle="modal"
                                data-target="#modal-delete"
                                data-whatever="{{route('user.delete_event',@$event->slug)}}"><i
