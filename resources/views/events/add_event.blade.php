...
<div class="row">
    ...
    <div class="badge text-danger badge-light mb-4 py-2" style="line-height: 2.4;">
        ...
        publier votre évènement.<br>Vous pouvez tout de même l'enregistrer en brouillon. Vous pouvez aussi <a
            href="{{route('purchase_currency')}}" class="btn btn-sm btn-success"> Recharger votre portefeuille.</a>
    </div>
    @endif
                ...
                <form action="{{route('user.store_event')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="offset-sm-0 col-12 form-group row">
                            ...
                            <select name="owner" id="owner" class="form-control">
                                ...
                                <option value="{{$child->id}}"
                                    {{old("owner",@$event->owner) == $child->id?'selected':'' }}> {{$child->username}}
                                </option>
                                @empty
                        ...
                        <div class="col-sm-6 form-group row mt-5">
                            <a href="{{route('user.edit_announcement',@$announcement)}}" class="btn btn-success"><i
                                    class="fa fa-angle-double-left"></i> Éditer l'annonce à relier à cette activité</a>
                        </div>
                        <div class="offset-sm-0 col-sm-6 form-group row mt-5">
                            ...
                            <div class="offset-sm-4 col-sm-8 form-group row mt-5">
                                ...
                                <button type="submit" class="btn btn-outline-primary"><i class="fa fa-save"></i>
                                    Enregistrer l'événement</button>
                            </div>
                        </div>
                </form>
            </div>
