<div class="mozaique-item visible col-sm-6 col-md-4" data-region="{{@$item->region->slug}}"
    data-city="{{@$item->city->slug}}" data-category="{{@$item->category->slug}}"
    data-organisation="{{@$item->organisation->slug}}" data-price="{{@$item->price}}">
    <div class="card shadow-sm p-0">
        ...
        <div class="card-body p-0">
            ...
            <div class="d-block" style="background: #dcdcdc; padding: 0;">
                @if(class_basename(@$item) === 'Event')
                <div type="button" class="px-1" id="item_price">
                    {{date('d/m/Y', strtotime(@$item->event_dates[0]->event_date) )}}</div>
