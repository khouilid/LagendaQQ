...
<section class="home">
        ...
        <div class="content active">
            ...
            <p class="w-50">sans payer de franchise (sans investir), crée pour jeunes, anciens jeunes, handicapés, retraités, des personnes en convalescence, policiers, curés, députés.</p>
        </div>
        <div class="content">
            <h1>Un site avec 101<br><span>raisons</span></h1>
            <p class="w-50">pour toutes situations, permettant à tous les intéressés de faire de l’argent, en aidant aux activités.</p>
        </div>
        <div class="content">
            <h1>Vous avez 14 ans.<br><span> ou même, vous dépassez 94 ans</span></h1>
            <p class="w-50">nous avons un poste pour vous. Environ 75% c’est du télétravail, et 25% des ventes.</p>
        </div>
