                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-12 no-padding">
                                <div class="form-group tw-form-round-shape">
                                    <input type="text" id="search_q" name="search_q" placeholder="Que cherchez vous ?"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12 no-padding">
                                <div class="form-group tw-form-round-shape">
                                    <select id="content_type" name="content_type" placeholder="Où ?"
                                        ...
                                        <option value="evènement"
                                            {{old('content_type',@$content_type) == 'evènement'?'selected':''}}>
                                            Evènements</option>
                                        <option value="annonce"
                                            {{old('content_type',@$content_type) == 'annonce'?'selected':''}}>Annonces
                                        </option>
                                    </select>
                                </div>
                            </div>
...
<section id="tw-blog" class="tw-blog">
    <div class="container">
        ...
        <div class="row wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
            ...
            @empty
            <h1 class="text-center" style="color: #d2d2d1">Nous n'avons rien trouvé correspondant à votre recherche.
            </h1>
            @endforelse
