...
class UserController extends Controller
{
    ...
    {
        $this->middleware(['auth','verified','role:super-admin|admin|chef-vendeur|vendeur|banquier'],['except' => ['updateInfosPerso','updatePWD','assignRole','assignRoleCheckout']]);
    }
            ...
            return Datatables::of($data)
                ...
                ->addColumn('updated_at', function($row){
                 ...
                 ->addColumn('action',function ($row) {
                    ...
                    $delete_route = route('vendeurs.delete',$row->id);
                    //  $modal_togglers = [
                    //     [
